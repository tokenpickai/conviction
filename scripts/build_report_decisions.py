...
def base_decision(item, action):
    ...
    return {
        ...
        "explicit_stance_posts": item.get("explicit_stance_posts"),
        "explicit_stance_days": item.get("explicit_stance_days"),
        "reasoned_explicit_posts": item.get("reasoned_explicit_posts"),
        "author_signal_ratio": item.get("author_signal_ratio"),
